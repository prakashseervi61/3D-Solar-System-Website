...
const planetData: PlanetData[] = [
  ...
  },
  {
    id: 2,
    name: "Venus",
    description: "Often called Earth's twin because of their similar size and mass.",
    diameter: "12,104 km",
    distanceFromSun: "108.2 million km",
    dayLength: "243 Earth days",
    yearLength: "225 Earth days",
    funFact: "Venus spins in the opposite direction to most planets, so the Sun rises in the west.",
    color: "#E8CDA0",
    radius: 1.0,
    position: [0, 0, -65],
    rotationSpeed: 0.003,
  ...
  },
  {
    ...
    funFact: "Saturn could float in water because its density is less than water.",
    color: "#E8D191",
    radius: 2.4,
    position: [0, 0, -230],
    rotationSpeed: 0.007,
  ...
  },
  {
    ...
    funFact: "Uranus rotates on its side, likely due to a collision with an Earth-sized object.",
    color: "#73C2BE",
    radius: 1.6,
    position: [0, 0, -275],
    rotationSpeed: 0.006,
  ...
  },
  {
    ...
    funFact: "Neptune was the first planet located through mathematical predictions rather than observation.",
    color: "#3F54BA",
    radius: 1.5,
    position: [0, 0, -320],
    rotationSpeed: 0.006,
